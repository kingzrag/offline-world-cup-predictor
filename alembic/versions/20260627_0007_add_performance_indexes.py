...
def upgrade():
    ...
    existing_indexes = inspector.get_indexes('matches') + inspector.get_indexes('teams')
    existing_index_names = {idx['name'] for idx in existing_indexes}
    
    # Indexes for matches table
    if 'ix_matches_home_team_id' not in existing_index_names:
        op.create_index('ix_matches_home_team_id', 'matches', ['home_team_id'])
    
    if 'ix_matches_away_team_id' not in existing_index_names:
