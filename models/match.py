...
class Match(Base):
    ...
    statsbomb_id = Column(String(50), unique=True, index=True, nullable=True)
    ...
    )  # e.g., SCHEDULED, FINISHED, POSTPONED, IN_PLAY
    ...
    player_performances = relationship(
        "PlayerMatchPerformance", back_populates="match", cascade="all, delete-orphan"
    )
